...
$(document).ready(function() {
    $.addCommit = function(comment, postId) {
        ...
        itemDetail += '<div class="comment">' +
            '<a href="/user/profile/'+ comment.owner.username +'" class="comment-avatar pull-left"><img src="' + ((comment.owner.portrait != null && comment.owner.portrait !== "") ? "/userimg/" + comment.owner.portrait : "/img/user.png") + '" alt=""/></a><div class="comment-text">' +
